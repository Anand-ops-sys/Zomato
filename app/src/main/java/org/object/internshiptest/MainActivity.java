package org.object.internshiptest;
...
import org.object.internshiptest.adapter.AsiaFoodAdapter;
import org.object.internshiptest.adapter.PopularFoodAdapter;
import org.object.internshiptest.model.AsiaFood;
import org.object.internshiptest.model.PopularFood;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        asiaFoodList.add(new AsiaFood("Chicago Pizza", "Rs.l20", R.drawable.asiafood1, "4.5", "Briand Restaurant"));
        asiaFoodList.add(new AsiaFood("Straberry Cake", "Rs.25", R.drawable.asiafood2, "4.2", "Friends Restaurant"));
        asiaFoodList.add(new AsiaFood("Chicago Pizza", "Rs.20", R.drawable.asiafood1, "4.5", "Briand Restaurant"));
        asiaFoodList.add(new AsiaFood("Straberry Cake", "Rs.25", R.drawable.asiafood2, "4.2", "Friends Restaurant"));
        asiaFoodList.add(new AsiaFood("Chicago Pizza", "Rs.20", R.drawable.asiafood1, "4.5", "Briand Restaurant"));
        asiaFoodList.add(new AsiaFood("Straberry Cake", "Rs.25", R.drawable.asiafood2, "4.2", "Friends Restaurant"));
